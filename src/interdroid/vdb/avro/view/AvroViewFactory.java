...
public class AvroViewFactory {
    ...
    private static UriArray<Object> getArray(Uri uri, ValueHandler valueHandler, Schema schema) {
        ...
        if (array == null) {
            array = new UriArray<Object>(valueHandler.getValueUri(uri), schema);
    ...
    private static View buildFieldView(boolean isRoot, AvroBaseEditor activity, AvroRecordModel dataModel, UriRecord record, ViewGroup viewGroup, Field field) throws NotBoundException {
        ...
        buildView(isRoot, activity, dataModel, viewGroup, field.schema(), record.getInstanceUri(), new RecordValueHandler(dataModel, record, field.name()));
